    ...
    >
      ...
      <div className="relative z-10 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white bg-opacity-95 rounded-xl shadow-lg p-6 mb-8 backdrop-blur-sm">
            ...
            <div>
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  ...
                  className="text-white hover:text-primary-300 font-medium bg-white bg-opacity-20 px-4 py-2 rounded-lg backdrop-blur-sm"
                >
                  Clear Filters
                </button>
              </div>
              ...
              {(filteredMonuments?.length ?? 0) === 0 ? (
                <div className="text-center py-20">
                  ...
                  <p className="text-gray-200">Try adjusting your search criteria</p>
                </div>
              ) : (
